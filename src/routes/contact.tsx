...
function Contact() {
  return <div className="min-h-dvh bg-slate-50 text-slate-900">
    <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/90 backdrop-blur"><div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6"><a href="/" className="text-lg font-extrabold tracking-tight">Blamo<span className="text-slate-400"> Closing</span></a><nav className="flex items-center gap-5 text-sm font-medium"><a href="/" className="rounded-lg py-2 text-slate-500 hover:text-slate-900">Home</a><a href="/contact" className="rounded-lg py-2 text-slate-900">Contact</a></nav></div></header>
