...
const HERO_COPY = {
  ...
  highlights: [
    ...
    `${SIX_NINETY_NINE_COUNT} training products for only $1.99`,
  ],
  ...
  async function handleCheckout() {
    ...
    try {
      ...
      if (error instanceof Error && error.message === "login_required") {
        ...
        window.location.href = `/login?next=${encodeURIComponent(`/training#${anchor}`)}`;
        return;
      }
      setErrorMsg(
 ...
 * (existing design language). The $1.99 playbooks remain standalone products:
...
function InternetSalesProductCard() {
  return (
    <ProductCoverCard
      ...
      price="$1.99"
      slug="internet-sales"
      ctaLabel="Buy now — $1.99"
      ctaAriaLabel="Get The 10 Steps to the Internet Sale — $1.99"
...
function SpouseProductCard() {
  return (
    <ProductCoverCard
      ...
      slug="spouse"
      ctaLabel="Buy now — $1.99"
      ctaAriaLabel="Get The Spouse Objection Playbook — $1.99"
...
function PrayAboutItProductCard() {
  return (
    <ProductCoverCard
      ...
      slug="pray-about-it"
      ctaLabel="Buy now — $1.99"
      ctaAriaLabel="Get The “Pray About It” Objection Playbook — $1.99"
...
function TradeInProductCard() {
  return (
    <ProductCoverCard
      ...
      slug="trade-in"
      ctaLabel="Buy now — $1.99"
      ctaAriaLabel="Get The “I Want More for My Trade-In” Playbook — $1.99"
...
function TradeInTaxCreditProductCard() {
  return <ProductCoverCard img="/cover-thumbs/trade-in-tax-credit.png" alt="Understanding Trade-In Tax Credit cover" badge={<QuickCardBadge />} title="Understanding Trade-In Tax Credit — How to Explain It Clearly to Customers" desc="Explain the tax savings clearly, answer common trade-in questions, and transition from education to the close." price="$1.99" slug="trade-in-tax-credit" ctaLabel="Buy now — $1.99" ctaAriaLabel="Get Understanding Trade-In Tax Credit — $1.99" chipTitle="Make the tax savings easy to understand." chipSub="4-page PDF guide" />;
}
...
function QualifyingQuestionsProductCard() {
  return (
    <ProductCoverCard
      ...
      ctaLabel="Buy now — $1.99"
      ctaAriaLabel="Get The Qualifying Questions Guide — $1.99"
...
function FollowUpProductCard() { return <ProductCoverCard img="/cover-thumbs/follow-up-that-creates-customers-for-life.png" alt="Follow-Up That Creates Customers for Life cover" badge={<QuickCardBadge />} title="Follow-Up That Creates Customers for Life" desc="A 14-page guide to the 10-day prospect plan, the SOLD customer process, and follow-up scripts that turn one sale into a customer for life." price="$1.99" slug="follow-up" ctaLabel="Buy now — $1.99" ctaAriaLabel="Get Follow-Up That Creates Customers for Life — $1.99" chipTitle="The sale doesn’t end when they leave." chipSub="14-page PDF guide" />; }
function SalesLogTemplateProductCard() { return <ProductCoverCard img="/cover-thumbs/sales-log-template.png" alt="Sales Log Template cover" badge={<QuickCardBadge />} title="Sales Log Template — Deals, Gross & Commission" desc="Track every deal: date, stock, units, splits, front/back gross, commission — with printable + Excel formats." price="$1.99" slug="sales-log-template" ctaLabel="Buy now — $1.99" ctaAriaLabel="Get Sales Log Template — $1.99" chipTitle="Track the deal. Know the numbers." chipSub="Printable + Excel" />; }
function MeetAndGreetProductCard() { return <ProductCoverCard img="/cover-thumbs/meet-and-greet-mastery.png" alt="Meet & Greet Mastery cover" badge={<QuickCardBadge />} title="Meet & Greet Mastery" desc="The 10-second rule, word-for-word opening scripts, body language DOs and DON'Ts, four personality types, and questions that open real conversations." price="$1.99" slug="meet-and-greet" ctaLabel="Buy now — $1.99" ctaAriaLabel="Get Meet & Greet Mastery — $1.99" chipTitle="The first five minutes determine the next five hours." chipSub="13-page PDF guide" />; }

/* ---------- Español (Phase 1) cover cards — Spanish versions ---------- */
function StarterKitEsProductCard() { return <ProductCoverCard img="/cover-thumbs/starter-kit-es.png" alt="Portada del Kit de Inicio del Vendedor" badge={<QuickCardBadge />} title="El Kit de Inicio del Vendedor" desc="El proceso completo de Los 10 Pasos de la Venta — 27 páginas con guiones palabra por palabra, listas de verificación y un plan de práctica de 7 días." price="$9.99" slug="starter-kit-es" ctaLabel="Comprar ahora — $9.99" ctaAriaLabel="Consigue El Kit de Inicio del Vendedor — $9.99" chipTitle="El proceso completo de 10 pasos" chipSub="Paquete de 27 páginas · Saludo → Seguimiento" />; }
function SpouseEsProductCard() { return <ProductCoverCard img="/cover-thumbs/spouse-es.png" alt="Portada del Manual de la Objeción del Cónyuge" badge={<QuickCardBadge />} title="El Manual de la Objeción del Cónyuge" desc="10 cierres palabra por palabra para “necesito consultarlo con mi esposo(a)” — y cómo distinguir una objeción real de una excusa para retrasar." price="$1.99" slug="spouse-es" ctaLabel="Comprar ahora — $1.99" ctaAriaLabel="Consigue El Manual de la Objeción del Cónyuge — $1.99" chipTitle="Respeta la pareja. Salva el trato." chipSub="Diez cierres, cero presión" />; }
function TradeInEsProductCard() { return <ProductCoverCard img="/cover-thumbs/trade-in-es.png" alt="Portada del Manual del “Quiero Más por Mi Trade-In”" badge={<QuickCardBadge />} title="El Manual del “Quiero Más por Mi Trade-In”" desc="10 cierres para “quiero más por mi intercambio” — incluido el cierre de intercambio favorito del propietario." price="$1.99" slug="trade-in-es" ctaLabel="Comprar ahora — $1.99" ctaAriaLabel="Consigue El Manual del “Quiero Más por Mi Trade-In” — $1.99" chipTitle="Gana el trato completo, no un solo número." chipSub="El cierre de intercambio favorito" />; }
function QualifyingQuestionsEsProductCard() { return <ProductCoverCard img="/cover-thumbs/qualifying-questions-es.png" alt="Portada de la Guía de Preguntas de Calificación" badge={<QuickCardBadge />} title="La Guía de Preguntas de Calificación" desc="75 preguntas en nueve categorías — el Golden 10 y el flujo completo de Razón → Compromiso." price="$1.99" slug="qualifying-questions-es" ctaLabel="Comprar ahora — $1.99" ctaAriaLabel="Consigue La Guía de Preguntas de Calificación — $1.99" chipTitle="Haz mejores preguntas." chipSub="75 preguntas · Golden 10" />; }

function InternetSaleEsProductCard() { return <ProductCoverCard img="/cover-thumbs/internet-sale-es.png" alt="Los 10 Pasos de la Venta por Internet" badge={<QuickCardBadge />} title="Los 10 Pasos de la Venta por Internet" desc="Guía práctica de capacitación automotriz en español." price="$1.99" slug="internet-sale-es" ctaLabel="Comprar ahora — $1.99" ctaAriaLabel="Consigue Los 10 Pasos de la Venta por Internet — $1.99" chipTitle="Guía PDF en español" chipSub="Lectura práctica" />; }
function PrayAboutItEsProductCard() { return <ProductCoverCard img="/cover-thumbs/pray-about-it-es.png" alt="El Manual de la Objeción 'Déjeme Orarlo'" badge={<QuickCardBadge />} title="El Manual de la Objeción 'Déjeme Orarlo'" desc="Guía práctica de capacitación automotriz en español." price="$1.99" slug="pray-about-it-es" ctaLabel="Comprar ahora — $1.99" ctaAriaLabel="Consigue El Manual de la Objeción 'Déjeme Orarlo' — $1.99" chipTitle="Guía PDF en español" chipSub="Lectura práctica" />; }
function WalkAroundEsProductCard() { return <ProductCoverCard img="/cover-thumbs/walk-around-es.png" alt="Guía de Capacitación del Recorrido del Vehículo" badge={<QuickCardBadge />} title="Guía de Capacitación del Recorrido del Vehículo" desc="Guía práctica de capacitación automotriz en español." price="$1.99" slug="walk-around-es" ctaLabel="Comprar ahora — $1.99" ctaAriaLabel="Consigue Guía de Capacitación del Recorrido del Vehículo — $1.99" chipTitle="Guía PDF en español" chipSub="Lectura práctica" />; }
function FIAwarenessEsProductCard() { return <ProductCoverCard img="/cover-thumbs/fi-awareness-es.png" alt="El Manual de Capacitación en F&I" badge={<QuickCardBadge />} title="El Manual de Capacitación en F&I" desc="Guía práctica de capacitación automotriz en español." price="$1.99" slug="fi-awareness-es" ctaLabel="Comprar ahora — $1.99" ctaAriaLabel="Consigue El Manual de Capacitación en F&I — $1.99" chipTitle="Guía PDF en español" chipSub="Lectura práctica" />; }
                ...
                <div className="text-center lg:text-left">
                  ...
                  <div className="mt-8 flex justify-center lg:justify-start">
                    <BuyButton
                      ...
                      ariaLabel="Get The Complete Package — everything you need to be successful in sales — $34.95"
                    />
                  </div>
                </div>
              </div>
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-white/85 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <a
              href="/training#internet-sales"
              className="rounded-lg py-2.5 text-sm font-medium text-slate-500 transition hover:text-slate-900"
            >
              The Internet Sale
            </a>
            <a
              href="/training#spouse"
              className="rounded-lg py-2.5 text-sm font-medium text-slate-500 transition hover:text-slate-900"
            >
              Spouse
            </a>
            <a
              href="/training#pray-about-it"
              className="rounded-lg py-2.5 text-sm font-medium text-slate-500 transition hover:text-slate-900"
            >
              Pray About It
            </a>
            <a
              href="/training#trade-in"
              className="rounded-lg py-2.5 text-sm font-medium text-slate-500 transition hover:text-slate-900"
            >
              Trade-In
            </a>
            <a
              href="/training#qualifying-questions"
              className="rounded-lg py-2.5 text-sm font-medium text-slate-500 transition hover:text-slate-900"
            >
...
<p className="mt-4 inline-flex rounded-full bg-amber-100 px-4 py-2 text-sm font-semibold text-amber-900">Every guide now includes the MP3 audio version — listen and learn on the go.</p>
            ...
            <div className="mt-3 flex flex-wrap items-center justify-center gap-3 sm:mt-9 sm:gap-5 sm:justify-start">
              <a href="/training" className="group inline-flex items-center justify-center gap-2 rounded-xl bg-amber-500 px-6 py-3 text-base font-bold sm:px-7 sm:py-4 text-slate-950 shadow-lg shadow-amber-500/30 transition hover:bg-amber-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500">{HERO_COPY.primaryCta}<ArrowIcon className="h-5 w-5 transition-transform group-hover:translate-x-0.5" /></a>
      ...
      {/* Training CTA — the catalog now has its own focused page. */}
      <section id="buy" className="bg-slate-900 relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-16 text-center sm:py-20">
          ...
          <h2 className="mt-6 text-3xl font-extrabold tracking-tight text-white sm:text-4xl">See all {STORE_PRODUCTS.length} training programs</h2>
          <p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-slate-300">Practical PDF guides and MP3 audio for every part of the automotive sale. Browse the full library or get the Complete Package in one unlock.</p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a href="/training" className="inline-flex items-center gap-2 rounded-xl bg-amber-500 px-7 py-4 font-bold text-slate-950 shadow-lg hover:bg-amber-400">Browse all training programs <ArrowIcon className="h-5 w-5" /></a>
            <a href="/training" className="inline-flex items-center rounded-xl border border-slate-500 px-7 py-4 font-bold text-white hover:border-white">Get the Complete Package</a>
          </div>
        </div>
      </section>
      {/* FAQs */}
        ...
        <div className="relative mx-auto grid max-w-6xl gap-16 px-6 py-20 sm:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-12 lg:py-28">
          <div className="max-w-2xl text-center sm:text-left">
            ...
            <div className="mt-9 flex justify-center sm:justify-start">
              <BuyButton
                slug="internet-sales"
                label="Get The 10 Steps to the Internet Sale — $1.99"
                ariaLabel="Get The 10 Steps to the Internet Sale — $1.99"
              />
            </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
       * THE SPOUSE OBJECTION PLAYBOOK — FIFTH PRODUCT ($1.99)
       * ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="relative mx-auto grid max-w-6xl gap-16 px-6 py-20 sm:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-12 lg:py-28">
          <div className="max-w-2xl text-center sm:text-left">
            ...
            <div className="mt-9 flex justify-center sm:justify-start">
              <BuyButton
                slug="spouse"
                label="Get The Spouse Objection Playbook — $1.99"
                ariaLabel="Get The Spouse Objection Playbook — $1.99"
              />
            </div>
            <p className="mt-5 text-sm text-slate-500">
              Instant download · 14-page PDF · $1.99 · Same-day use
            </p>
            <p className="mt-3 text-sm">
              <a
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-6 sm:py-24">
          ...
          <div className="mt-4 grid gap-3 sm:mt-12 sm:gap-6 lg:grid-cols-[1fr_0.9fr] lg:items-start">
            ...
            <aside className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-7 shadow-sm">
              ...
              <p className="mt-5 border-t border-slate-100 pt-5 text-sm leading-relaxed text-slate-500">
                Sold separately at $1.99 — pairs with the Starter Kit to
      ...
      {/* ═══════════════════════════════════════════════════════════
       * THE "PRAY ABOUT IT" OBJECTION PLAYBOOK — SIXTH PRODUCT ($1.99)
       * ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="relative mx-auto grid max-w-6xl gap-16 px-6 py-20 sm:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-12 lg:py-28">
          <div className="max-w-2xl text-center sm:text-left">
            ...
            <div className="mt-9 flex justify-center sm:justify-start">
              <BuyButton
                slug="pray-about-it"
                label="Get The “Pray About It” Objection Playbook — $1.99"
                ariaLabel="Get The “Pray About It” Objection Playbook — $1.99"
              />
            </div>
            <p className="mt-5 text-sm text-slate-500">
              Instant download · 13-page PDF · $1.99 · Same-day use
            </p>
            <p className="mt-3 text-sm">
              <a
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-6 sm:py-24">
          ...
          <div className="mt-4 grid gap-3 sm:mt-12 sm:gap-6 lg:grid-cols-[1fr_0.9fr] lg:items-start">
            ...
            <aside className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-7 shadow-sm">
              ...
              <p className="mt-5 border-t border-slate-100 pt-5 text-sm leading-relaxed text-slate-500">
                Sold separately at $1.99 — pairs with the Starter Kit to keep
      ...
      {/* ═══════════════════════════════════════════════════════════
       * THE "I WANT MORE FOR MY TRADE-IN" PLAYBOOK — SEVENTH PRODUCT ($1.99)
       * ═══════════════════════════════════════════════════════════ */}
        ...
        <div className="relative mx-auto grid max-w-6xl gap-16 px-6 py-20 sm:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-12 lg:py-28">
          <div className="max-w-2xl text-center sm:text-left">
            ...
            <div className="mt-9 flex justify-center sm:justify-start">
              <BuyButton
                slug="trade-in"
                label="Get The “I Want More for My Trade-In” Playbook — $1.99"
                ariaLabel="Get The “I Want More for My Trade-In” Playbook — $1.99"
              />
            </div>
            <p className="mt-5 text-sm text-slate-500">
              Instant download · 15-page PDF · $1.99 · Same-day use
            </p>
            <p className="mt-3 text-sm">
              <a
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-6 sm:py-24">
          ...
          <div className="mt-4 grid gap-3 sm:mt-12 sm:gap-6 lg:grid-cols-[1fr_0.9fr] lg:items-start">
            ...
            <aside className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-7 shadow-sm">
              ...
              <p className="mt-5 border-t border-slate-100 pt-5 text-sm leading-relaxed text-slate-500">
                Sold separately at $1.99 — pairs with the Sales Rep Starter Kit
          ...
          <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <BuyButton slug="qualifying-questions" label="Get The Qualifying Questions Guide — $1.99" ariaLabel="Get The Qualifying Questions Guide — $1.99" />
      ...
      <section className="relative overflow-hidden bg-slate-900"><BgArt side="right" dark /><div className="relative mx-auto max-w-4xl px-6 py-20 text-center sm:py-28"><LogoMark className="mx-auto h-12 w-12" /><h2 className="mt-6 text-3xl font-extrabold tracking-tight text-white sm:text-4xl">Ask better questions. Close with confidence.</h2><p className="mx-auto mt-4 max-w-xl text-lg leading-relaxed text-slate-300">Get The Qualifying Questions Guide — a 13-page PDF with 75 questions, the Golden 10, and a complete sales flow you can use today.</p><div className="mt-9 flex justify-center"><BuyButton slug="qualifying-questions" label="Get The Qualifying Questions Guide — $1.99" ariaLabel="Get The Qualifying Questions Guide — $1.99" /></div><p className="mt-5 text-sm"><a href="/thanks?product=qualifying-questions" className="inline-block rounded-lg py-3 font-medium text-slate-300 underline underline-offset-2 hover:text-white">Already purchased? Enter your code to download</a></p></div></section>
      ...
      <footer className="relative overflow-hidden border-t border-slate-200 bg-white">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-8 sm:flex-row">
          ...
          <nav className="flex flex-wrap justify-center gap-x-5 gap-y-1 text-sm text-slate-500">
            ...
            <a href="/training#trade-in" className="hover:text-slate-900">
              The Trade-In Playbook
            </a>
            <a href="/thanks?product=trade-in" className="hover:text-slate-900">
              Download the Trade-In Playbook PDF
            </a>
            <a href="/training#qualifying-questions" className="hover:text-slate-900">
              Qualifying Questions
            </a>
            ...
            <a href="/training" className="font-medium text-slate-900">
              Get the Starter Kit
            </a>
          </nav>
        </div>
