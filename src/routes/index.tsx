...
function ProductCoverCard({
  ...
  return (
    <div id={slug} className="product-card relative mx-auto w-full max-w-xs lg:max-w-sm">
  ...
  return (
      <section id="catalog" className="border-t border-slate-100 bg-slate-50 scroll-reveal relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 py-20 sm:py-24"><div className="text-center"><Eyebrow>Browse the training</Eyebrow><h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">Practical training for every part of the deal</h2><p className="mx-auto mt-4 max-w-2xl text-lg text-slate-600">{`${INDIVIDUAL_PRODUCT_COUNT} standalone training products, built for real dealership conversations.`}</p></div>
          ...
          <div className="mt-14">
            <div id="complete-package" className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950 shadow-2xl shadow-slate-900/40 ring-2 ring-amber-400/60">
              {/* BEST VALUE ribbon */}
          ...
          <div id="mobile-menu" className="border-t border-slate-200 bg-white shadow-xl lg:hidden">
            <nav aria-label="Mobile" className="mx-auto max-w-6xl px-4 py-4 sm:px-6">
              ...
              <div className="mt-2 grid gap-1">
                {[
                  ["10 Steps of the Sale", "/training"],
                  ["The Internet Sale", "/training#internet-sales"],
                  ["Spouse", "/training#spouse"],
                  ["Pray About It", "/training#pray-about-it"],
                  ["Trade-In", "/training#trade-in"],
                  ["Qualifying Questions", "/training#qualifying-questions"],
                  ["En Español", "/es"],
                  ["Contact", "/contact"],
                ].map(([label, href]) => (
                  <a
          ...
          <div className="mt-4 grid gap-3 sm:mt-12 sm:gap-6 lg:grid-cols-[1fr_0.9fr] lg:items-start">
            <ul className="grid grid-cols-2 gap-2 sm:gap-4 sm:grid-cols-2">
              {[
                ...
                <li
                  key={item}
                  className="flex items-start gap-3 rounded-xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm"
                >
